...
MiniMap::MiniMap(vector <std::shared_ptr<Cell>> cellsVector, vector <std::shared_ptr<Skeleton>> Skeletons, vector <std::shared_ptr<Medusa>> Medusa)
{
...
void MiniMap::MiniMapUpdate(sf::RenderWindow * passedWindow, vector <std::shared_ptr<Cell>> cellsVector, vector <std::shared_ptr<Skeleton>> Skeletons, vector <std::shared_ptr<Medusa>> Medusa, PlayerCharacter* playerCharacter)
{
